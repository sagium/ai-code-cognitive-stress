...
the day. A descriptive mean $\overline{\mathrm{CODL}}=\frac{1}{|T|}\sum_{t\in T}
...
\paragraph{Single subject and borrowed thresholds.} The working-memory capacity
($\kappa\approx 4$~\cite{cowan2001}), the CODL dose horizon ($D$), and the
interruption ceiling ($10$/hour) are literature-anchored priors, not fitted to
the population of agentic-coding software engineers, who
...
the thresholds stay borrowed and the data stays $n{=}1$ (\S\ref{sec:validation}).
